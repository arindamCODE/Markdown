import { Component, OnInit, ViewChild, forwardRef, Renderer, Attribute, Input, ElementRef } from '@angular/core';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => MarkComponent),
      multi: true
    },
    {
...
export class MarkComponent implements OnInit, ControlValueAccessor, Validator {
